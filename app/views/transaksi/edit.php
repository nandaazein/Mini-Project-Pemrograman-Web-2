                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="id_nasabah">
                      <?php foreach ($data['nasabah'] as $row) :?>
                        <?= '<option value="' . $row['id_nasabah'] .'">' .$row['id_nasabah']. '</option>' ;?>
                      <?php $no++; endforeach; ?>
                    </select>
                    <label >Tanggal Transaksi</label>
                    <input type="date" class="form-control" placeholder="masukkan tanggal transaksi" name="tanggal_transaksi" value="<?= $data['transaksi']['tanggal_transaksi'];?>">
